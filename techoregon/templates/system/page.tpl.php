...
<header id="navbar" role="banner" class="navbar">
  <div class="navbar-container <?php print $container_class; ?>">
...
<div class="main-content-container">
  ...
  <!-- Page title, admin tabs, notifications -->
  <?php if (!empty($title)): ?>
  ...
  <?php if (!empty($messages) || !empty($tabs) || !empty($page['help']) || !empty($action_links)): ?>
    <div class="admin-tabs-container container">
